        ...
        <br/>
          <form>
            ...
            <label>
              ...
              <input type="zip" className="form-control" id="orgZip" placeholder="Zip" value={this.state.orgZip} onChange={this.handleChange} />
            </label>
          </form>
          <hr/>
          ...
          DESTINATION
            <label>
              ...
              <input type="zip" className="form-control" id="destZip" placeholder="Zip" value={this.state.destZip} onChange={this.handleChange} />
            </label>
